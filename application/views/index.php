...
<html>
   <head>
      <meta charset="utf-8">
      <title>CV Gemilang Lestari Jaya</title>
         ...
         <nav class="materialize-red">
            <div class="nav-wrapper container">
               <ul id="nav-mobile" class="right hide-on-med-and-down">
                  ...
                  <?php if ($this->session->userdata('user_login')) { ?>
                     ...
                     <li><a href="#" class="dropdown-button" data-activates="drop1"><i class="fa fa-user"></i>Hai <?= ucwords($this->session->userdata('name')); ?><i class="fa fa-caret-down right"></i></a></li>
            ...
            <ul id="slide-out" class="side-nav">
               ...
               <?php if ($this->session->userdata('user_login')) { ?>
                  ...
                  <li><a href="#" class="dropdown-button" data-activates="drop2">Hai<i class="fa fa-user"></i><?= ucwords($this->session->userdata('name')); ?><i class="fa fa-caret-down right"></i></a></li>
 ...
 <p></p><br>
               ...
               <p></p><br>
                <p></p><br>
               <p></p><br>
            <footer class="materialize-red">
               <div class="container">
                  <div class="row">
                     <div class="col l6 s12">
                        <h5 class="white-text">Alamat Perusahaan</h5>
                        <p class="grey-text text-lighten-4">Jl. Ciater Raya, Vila Dago Tol, D2/46 RT.002/019, Serua, Ciputat, Tangerang Selatan, Banten.<br /><i class="fa fa-phone-square"></i> +622171479503</p>
                     </div>
               ...
               <div class="footer-copyright">
                  <div class="container">
                     Copyright © 2019 CV GEMILANG LESTARI JAYA. All Rights Reserved.
                     <span class="grey-text text-lighten-4 right">Develope By <a class="blue-text text-lighten-4">GLJ</a></span>
                  </div>
               </div>
            </footer>
        </main>
