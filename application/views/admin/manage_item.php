   ...
   <div class="x_title">
      ...
      <div style="float:right">
         <a href="<?= base_url(); ?>item/add_item" class="btn btn-primary">Tambah Item</a>
           <a href="<?= base_url(); ?>administrator/cetak_laporan_item" target="_blank" class="btn btn-warning"><i class="fa fa-print"> Print</i></a>
      </div>
                  ...
                  <tr>
                     ...
                     <td>
                        ...
                        <a href="<?= base_url(); ?>item/update_item/<?= $items->id_item; ?>" class="btn btn-warning"><i class="fa fa-edit"></i></a>
                         <a href="<?= base_url(); ?>item/hapus_item/<?= $items->id_item; ?>" class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus item ini?')"><i class="fa fa-trash"></i></a>
                     </td>
                  </tr>
                  <?php endforeach; ?>
               </tbody>
