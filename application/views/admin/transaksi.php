<div class="x_panel">
   <div class="x_title">
     ...
     <div style="float:right">
      <a href="<?= base_url(); ?>administrator/cetak_laporan_order" target="_blank" class="btn btn-warning"><i class="fa fa-print"> Print</i></a>
   </div>
</div>
         ...
         <tbody>
            ...
            <tr>
               ...
               <td style="vertical-align:middle">
                  <?php if ($batas < $today && $key->status_byr == 'belum') { ?>
                  ...
                  <?php } else { ?>
                     ...
                     <a href="<?=base_url();?>transaksi/konfirmasi/<?=$key->id_order;?>" class="btn btn-success" <?php if ($key->status_byr == 'proses') { echo 'disabled'; } ?>><i class="fa fa-check"></i></a>
