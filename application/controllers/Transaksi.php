...
class Transaksi extends CI_Controller {
   ...
   public function index()
   {
      ...
      $select = ['id_order', 'tgl_pesan', 'bts_bayar', 'fullname', 'o.status_byr AS status_byr'];
   ...
   public function konfirmasi()
   {
      ...
      $this->admin->update('t_order', ['status_byr' => 'proses'], ['id_order' => $this->uri->segment(3)]);
   ...
   public function detail()
   {
      ...
      $select = ['o.id_order AS id_order', 'tgl_pesan', 'bts_bayar', 'fullname', 'o.status AS status_byr', 'pos', 'service', 'kota', 'tujuan', 'total', 'biaya', 'kurir', 'nama_item', 'qty'];
	...
	public function report()
	{
		...
		$where = ['tgl_pesan >=' => $awal, 'tgl_pesan <=' => $akhir, 'o.status_byr' => 'proses'];
